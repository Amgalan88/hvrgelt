        ...
        <footer className="bg-background border-t border-border px-5 py-6" style={{ fontFamily: "'Inter', sans-serif" }}>
          <div className="max-w-sm mx-auto space-y-5">
            ...
            <div className="space-y-1.5">
              <p className="text-sm font-medium">Дарханы хурдан хүргэлт</p>
              <p className="text-xs text-muted-foreground leading-relaxed">
                Захиалга өгөхөөс хүргэлт хүлээн авах хүртэл бүгдийг шийднэ.
              </p>
              <div className="flex gap-4 text-xs text-muted-foreground pt-0.5">
                <a href="tel:99739959" className="hover:text-foreground transition-colors">📞 9973-9959</a>
