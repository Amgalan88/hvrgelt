  ...
  if (!landingDone) {
    return (
      <div className="min-h-dvh bg-background text-foreground flex flex-col" style={{ fontFamily: "'Inter', sans-serif" }}>
        ...
        {/* Footer */}
        <footer className="bg-background border-t border-border px-5 pt-4 pb-5" style={{ fontFamily: "'Inter', sans-serif" }}>
          <div className="max-w-sm mx-auto space-y-3">
            {/* Social + contact */}
            <div className="flex items-center gap-3">
              <a href="https://www.facebook.com/hvrgelt.mn" target="_blank" rel="noreferrer"
                className="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl border border-border text-xs text-muted-foreground hover:text-foreground hover:border-primary/40 transition-all">
              ...
              <a href="tel:85205258" className="flex items-center justify-center w-10 h-10 rounded-xl border border-border text-muted-foreground hover:text-foreground hover:border-primary/40 transition-all shrink-0">
            ...
            <div className="flex items-center justify-between text-xs text-muted-foreground/60">
              ...
              <span className="shrink-0 ml-2">© 2025</span>
            </div>
          </div>
        </footer>
      </div>
