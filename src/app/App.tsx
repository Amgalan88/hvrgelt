  ...
  if (!landingDone) {
    return (
      <div className="min-h-dvh bg-background text-foreground flex flex-col" style={{ fontFamily: "'Inter', sans-serif" }}>
        ...
        {/* Footer */}
        <footer className="bg-background/80 border-t border-border/60 px-5 py-5" style={{ fontFamily: "'Inter', sans-serif" }}>
          <div className="max-w-sm mx-auto">
            {/* Top row: brand + social icons */}
            <div className="flex items-center justify-between mb-4">
              <div>
                <p className="text-sm font-bold" style={{ fontFamily: "'Roboto Slab', serif" }}>
                  hvrgelt<span className="text-primary">.mn</span>
                </p>
                <p className="text-xs text-muted-foreground mt-0.5">Дарханы хурдан хүргэлт</p>
              </div>
              <div className="flex items-center gap-2">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs text-muted-foreground/40 shrink-0">© 2025</span>
            </div>
          </div>
        </footer>
      </div>
