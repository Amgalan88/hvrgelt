    ...
    const pages = {
      ...
      privacy: {
        ...
        content: [
          ...
          { heading: "4. Мэдээлэл устгах", body: "Өөрийн бүртгэл болон мэдээллийг устгахыг хүсвэл 88371961 дугаарт холбогдоно уу." },
      ...
      about: {
        ...
        content: [
          ...
          { heading: "Холбоо барих", body: "📞 88371961\n📍 Дархан хот\n🕐 Ажлын цаг: 08:00 – 22:00" },
        ],
      },
      contact: {
        title: "Холбоо барих",
        icon: Phone,
        content: [
          { heading: "Утас", body: "📞 88371961 — Өдрийн 08:00–22:00 цагт ажилладаг." },
